package com.haocang.bjxjc.ui.dialog;
...
public class CustomDialogFragment extends DialogFragment {
    ...
    public void onResume() {
        ...
        //设置对话框宽度
        if(dialogWidth > 0){
            getDialog().getWindow().setLayout(TextUtil.dip2px(getActivity(),dialogWidth), WindowManager.LayoutParams.WRAP_CONTENT);
        }else {
            getDialog().getWindow().setLayout(TextUtil.dip2px(getActivity(),250), WindowManager.LayoutParams.WRAP_CONTENT);
        }
    }
