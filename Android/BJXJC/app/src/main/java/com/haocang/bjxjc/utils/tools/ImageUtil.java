...
public class ImageUtil {
    ...
    public static void savePicUrl(final Context context, final String url) {
    ...
    public static void savePicBitmap(Context context, Bitmap bmp) {
        // 首先保存图片
        if (bmp == null) {
            ToastUtil.show("保存失败1");
            return;
        }
