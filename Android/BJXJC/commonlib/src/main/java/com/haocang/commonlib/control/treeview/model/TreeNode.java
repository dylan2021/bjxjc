package com.haocang.commonlib.control.treeview.model;
...
import com.haocang.commonlib.control.treeview.view.TreeNodeWrapperView;
...
public class TreeNode {
    ...
    public TreeNode(Object value,String tid) {
    ...
    public TreeNode(Object value,String tid,String url) {
        children = new ArrayList<>();
        mValue = value;
        T_ID = tid;
        Turl = url;
    ...
    public boolean isTParent() {
        return TParent;
    }

    public void setTParent(boolean TParent) {
