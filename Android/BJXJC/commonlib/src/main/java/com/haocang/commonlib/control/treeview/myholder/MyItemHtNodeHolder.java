 ...
 */
public class MyItemHtNodeHolder extends TreeNode.BaseNodeViewHolder<IconTreeItemHolder.IconTreeItem> {
    private TextView tvValue;
    private PrintView arrowView;
    private CheckBox nodeSelector;

    public MyItemHtNodeHolder(Context context) {
        super(context);
    }
    ...
    public View createNodeView(final TreeNode node, IconTreeItemHolder.IconTreeItem value) {
        ...
        final View view = inflater.inflate(R.layout.layout_selectable_myht_header, null, false);
