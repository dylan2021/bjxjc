 ...
 */
public class MyItemThree1Holder extends TreeNode.BaseNodeViewHolder<IconTreeItemHolder.IconTreeItem> {
    private TextView tvValue;
    private PrintView arrowView;
    private TextView nodeSelector;

    public MyItemThree1Holder(Context context) {
        super(context);
    }
    ...
    public View createNodeView(final TreeNode node, IconTreeItemHolder.IconTreeItem value) {
        ...
        final View view = inflater.inflate(R.layout.layout_myitem_31_header, null, false);
