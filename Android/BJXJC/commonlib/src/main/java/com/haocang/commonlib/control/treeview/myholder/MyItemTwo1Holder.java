 ...
 */
public class MyItemTwo1Holder extends TreeNode.BaseNodeViewHolder<IconTreeItemHolder.IconTreeItem> {
    private TextView tvValue;
    private PrintView arrowView;
    private CheckBox nodeSelector;

    public MyItemTwo1Holder(Context context) {
        super(context);
    }
    ...
    public View createNodeView(final TreeNode node, IconTreeItemHolder.IconTreeItem value) {
        ...
        final View view = inflater.inflate(R.layout.layout_myitem_21_header, null, false);
