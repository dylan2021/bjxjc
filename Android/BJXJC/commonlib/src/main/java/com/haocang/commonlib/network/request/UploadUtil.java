...
public class UploadUtil extends Request<String> {
    ...
    public UploadUtil(String url, Response.ErrorListener errorListener,
        ...
        Log.i(Config.LogFlag, "带图片请求：url:" + url);
        Log.i(Config.LogFlag, "带图片请求：params:" + params.toString());
     ...
     * @param params
     */
    public UploadUtil(String url, String filePartName, List<File> files,  JSONObject params,
    ...
    private void buildMultipartEntity() {
        if (mFileParts != null && mFileParts.size() > 0) {
            for (File file : mFileParts) {
                Log.i(Config.LogFlag, "添加mFilePartName:" + mFilePartName);
        ...
        try {
            Log.i(Config.LogFlag, "添加inputObj:" + mParams.toString());
