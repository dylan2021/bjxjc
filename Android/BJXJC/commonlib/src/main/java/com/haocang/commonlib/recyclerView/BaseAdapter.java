...
import com.haocang.commonlib.recyclerView.bean.IExpandable;
        ...
        if (onItemClickListener != null) {
            holder.getItemView().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    onItemClickListener.onItemClick(v, holder.getAdapterPosition() - getHeaderCount());
                }
            });
        }
        if (onItemLongClickListener != null) {
            holder.getItemView().setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return onItemLongClickListener.onItemLongClick(v, holder.getAdapterPosition() - getHeaderCount());
                }
            });
        }
    }
